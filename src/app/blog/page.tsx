...
export const metadata: Metadata = {
  ...
  description:
    "Read the latest Japan travel tips, guides, and stories. Get insider knowledge about Japanese culture, food, attractions, and travel planning advice.",
  keywords:
    "Japan travel blog, Japan travel tips, Japan travel guide, Japan culture, Japan food, Japan attractions, travel planning Japan",
};
...
const blogPosts = [
  {
    ...
    excerpt:
      "Discover the most beautiful and historically significant temples in Kyoto, from the iconic Fushimi Inari to the serene Kinkaku-ji Golden Pavilion.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "From hidden ramen shops to Michelin-starred sushi restaurants, discover the best places to eat in Tokyo that locals love.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Plan your perfect cherry blossom viewing experience with our guide to the best hanami spots across Japan, from Tokyo to Kyoto.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Everything you need to know about the Japan Rail Pass, including costs, coverage, and whether it's the right choice for your trip.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Travel Japan on a budget with these money-saving tips for accommodation, food, transportation, and attractions.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Learn the proper etiquette for visiting Japanese onsen, from bathing procedures to what to bring and cultural customs.",
    image:
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-red-100">
              Expert tips, travel guides, and insider knowledge to help you plan
              the perfect Japanese adventure.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                <div className="relative">
                  {blogPosts[0].image ? (
                    ...
                    <div className="aspect-[16/9] w-full bg-gray-200 flex items-center justify-center lg:aspect-[4/3]">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg leading-8 text-red-100">
              Subscribe to our newsletter for the latest Japan travel tips,
              guides, and exclusive deals.
            </p>
