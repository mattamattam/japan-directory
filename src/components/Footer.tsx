      ...
      <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-300">
              Your ultimate guide to Japan tourism. Discover the best hotels, attractions, restaurants, and travel tips for an unforgettable Japanese adventure.
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold leading-6">Destinations</h3>
        ...
        <div className="mt-16 border-t border-gray-800 pt-8">
          <p className="text-xs text-gray-400">
            <strong>Affiliate Disclosure:</strong> This website contains affiliate links. We may earn a commission when you click on or make purchases through these links at no additional cost to you. This helps support our website and allows us to continue providing free travel information.
          </p>
        </div>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="mt-4 sm:mt-0">
            <Button variant="outline" size="sm" className="text-gray-400 border-gray-600 hover:text-white hover:border-gray-500">
